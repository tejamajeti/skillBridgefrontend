...
const LearnerProfile = () => {
    ...
    return (
        <section className="learner-profile-container p-2">
            <ToastComponent />
            <LearnerHeader />
            <div className="learner-profile p-2 mt-2">
                <CgProfile className="profile-img" />
                <div className="profile-details">
                    <div>
                        <h1> Profile </h1>
                        <button type="button" id="editBtn" onClick={() => setEdit(true)}> edit info </button>
                    </div>
                    <div>
